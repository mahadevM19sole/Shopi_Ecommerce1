...
return (
    <div className="min-h-screen bg-gray-100 text-gray-900 py-10">
      <div className="container mx-auto px-4">
        <div className="bg-white p-6 rounded-lg shadow-lg md:flex">
          <div className="md:flex-shrink-0">
            <img
              src={product.images[0]}
              alt={product.title}
              className="rounded-lg md:w-64 md:h-64 object-cover"
            />
          </div>
        ...
        <div className="bg-white flex justify-evenly mt-6 p-6 rounded-lg shadow-lg">
          <ReviewProvider>
